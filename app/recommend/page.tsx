              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="mt-4">
                    ...
                    <textarea
                      ...
                      className="mt-2 h-44 w-full resize-none rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 outline-none ring-0 focus:border-violet-300 focus:ring-4 focus:ring-violet-100"
                    />
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                    ...
                    <div className="mt-2">
                      <select className="h-11 w-full rounded-xl border border-gray-200 bg-white px-4 text-sm text-gray-700 outline-none focus:border-violet-300 focus:ring-4 focus:ring-violet-100">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-900">
                    제약 조건 <span className="text-gray-400">(선택)</span>
                  </label>
                  <input
                    type="text"
                    placeholder="예: 한국어만 지원, 오프라인 사용 가능"
                    className="mt-2 h-11 w-full rounded-xl border border-gray-200 bg-white px-4 text-sm text-gray-900 placeholder:text-gray-400 outline-none focus:border-violet-300 focus:ring-4 focus:ring-violet-100"
                  />
                </div>
